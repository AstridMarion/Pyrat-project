...
#####################################################################################################################################################
    ...
    def traversal ( self:   Self,
        ...
        """
            ...
            Out:
                * distances:     The minimum distances from the source to each explored vertex.
        ...
        unvisited = set(graph.vertices) #less complex than a list to modify

        while unvisited:
            #find the nearest unvisited summit to the source
